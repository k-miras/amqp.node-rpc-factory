...
var rpcPublisherProto = {
  ...
  init: function (options) {
    ...
    this.queueOptions = options.queueOptions || {exclusive: false, autoDelete: true};
          ...
          .then(function createChannelSucces(ch) {
            ...
            function MaybeAnswer(msg) {
              if (msg.properties.correlationId === corrId) {
                ...
                ch.deleteQueue(replyQueue).then(ok=>{console.log("queue deleted")}).catch(err=>console.log("deleting error"));
                }
